...
SendStream.prototype.onStatError = function(err){
  ...
  console.log('STAT ERROR: ' + err.class);
...
SendStream.prototype.pipe = function(res){
  ...
  console.log("PIPING " + util.inspect(res));
  ...
  console.log('>>>> ABOUT TO STAT ' + path);
  debug('stat "%s"', path);
...
SendStream.prototype.send = function(path, stat){
  console.log("SendStream.prototype.send - path: " + path);
  console.log("SendStream.prototype.send - stat: " + stat);
  ...
  console.log(">>>> SETTING CONTENT LENGTH " + len);
